...
public class TemplateBuilder {
    ...
    //表筛选
    public static String TABLE_REGEX;
    ...
    static {
        try {
            ...
            TABLE_REGEX = props.getProperty("table");
            //工程路径
            ...
            if (databaseType.equals("MySQL")) {
                ...
                while (tableResultSet.next()) {
                    ...
                    if (!(tableName.matches(TABLE_REGEX) ||
                            (TABLE_REGEX.replace(" ", "") + ",").indexOf(tableName) > 0)) continue;
                    System.out.println("building ... tableName=" + tableName);
                    ...
                    if (key.isEmpty()) {
                        System.err.println(tableName + " 没有主键,生成失败!!!");
                        continue;
                    }
